...
var api = {
  getBooks: function getBooks() {
    return fetch('/api/books').then(function (res) {
      return res.json();
    });
  },

  getBook: function getBook(id) {
    return fetch('/api/books/' + id).then(function (res) {
      return res.json();
    });
  }
};
  ...
  _createClass(BooksList, [{
    ...
    value: function getData() {
      ...
      api.getBooks().then(function (data) {
        ...
        _this2.setState({ errorGetData: true });
      });
    }
  }, {
    key: 'li',
    value: function li(props) {
      ...
      var content = function content() {
        if (_this3.state.data) {
          return _react2.default.createElement(
            'ul',
            null,
            _this3.state.data.map(function (dataItem) {
              return _this3.li(dataItem);
            })
          );
        } else {
          _react2.default.createElement(
...
var Book = function (_React$Component2) {
  ...
  _createClass(Book, [{
    ...
    value: function getData() {
      ...
      api.getBook(this.state.id).then(function (data) {
        return _this5.setState({ data: data });
      }).catch(function (err) {
        return _this5.setState({ errorGetData: true });
      });
    }
  }, {
    key: 'componentWillMount',
...
var RouterRoot = function RouterRoot() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/books', component: BooksList }),
      _react2.default.createElement(_reactRouterDom.Route, { path: '/books/:id', component: Book })
    )
  );
};

_reactDom2.default.render(_react2.default.createElement(RouterRoot, null), document.getElementById('app'));
